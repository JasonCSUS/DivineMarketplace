...
/*
 * Layer : registry / custom items
 * Owns  : custom-item definitions, extraction support, or review logs
 * Calls : custom-item storage/log files only — never GUI or commands
 */
...
public final class DefaultCustomItemRegistry implements CustomItemRegistry {
    ...
    /** Loads all custom item definitions from the data source into the in-memory indexes. */
