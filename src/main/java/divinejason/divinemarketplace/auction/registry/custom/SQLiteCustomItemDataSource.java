...
public final class SQLiteCustomItemDataSource implements CustomItemDataSource {
    ...
    public SQLiteCustomItemDataSource(SQLiteMarketIndexStore marketIndexStore, SQLiteWriteBehindQueue writeBehindQueue) {
    ...
    public CustomItemDefinition upsertDefinition(CustomItemDefinition definition) {
        ...
        writeBehindQueue.enqueue(SQLiteWriteBatch.builder("custom item definition " + definition.itemType())
