 ...
 *
 * Startup flow:
 * - PluginFileInitializer ensures the live config files exist
 * - MainConfigLoader parses plugins/DivineMarketplace/config.yml
 * - ConfigService caches the resulting MainConfig for the rest of the plugin
 */
public final class ConfigService {
    ...
    public MainConfig getMainConfig() {
        if (mainConfig == null) {
            throw new IllegalStateException("MainConfig has not been loaded yet.");
        }
        return mainConfig;
    }
